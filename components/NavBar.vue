<template>
  <div class="drawer lg:drawer-open">
    ...
    <div class="drawer-content">
      <!-- Navbar -->
      <nav class="navbar w-full bg-app-secondary sticky top-0 z-50">
    ...
    <div class="drawer-side is-drawer-close:overflow-visible">
      ...
      <div class="flex min-h-full flex-col items-start bg-app-secondary is-drawer-close:w-14 is-drawer-open:w-64">
        <ul class="menu w-full grow">
          <li>
            <NuxtLink to="/" class="is-drawer-close:tooltip is-drawer-close:tooltip-right" data-tip="Homepage">
