<template>
  <footer class="bg-app-secondary overflow-hidden shadow-2xl">
    <div class="px-4 py-8">
      <div
        class="flex flex-col sm:flex-row justify-between items-start gap-6 sm:gap-0"
      >
      ...
      <div class="text-white/60 space-y-4">
        ...
        <div class="flex gap-2">
          ...
          <span class="flex gap-0.5">
            <img class="w-5" src="/assets/nuxt.svg" alt="" />
            <a
          ...
          <span class="flex gap-1">
            <img class="w-5" src="/assets/tailwindcss.svg" alt="" />
            <a
              class="text-white hover:text-white/75 hover:underline transition"
          ...
          <span>&</span>
          <span class="flex gap-1">
            <img class="w-5" src="/assets/supabase.svg" alt="" />
            <a
              class="text-white hover:text-white/75 hover:underline transition"
